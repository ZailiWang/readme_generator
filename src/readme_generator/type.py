...
class ModelWorkflowFlow(Flow[ModelWorkflowState]):
    ...
    def __init__(
        ...
        **kwargs):
        ...
        self.global_memory.memory_store("input_text",input_text)
...
def kickoff():
    ...
    input_text="""Generate standardized, clear, and readable README documents for the three specified Llama-3.2-3B models. The model list is ["Llama-3.2-3B-quantized.w8a8", "Llama-3.2-3B-Instruct-FP8", "Llama-3.2-3B-Instruct-AWQ"]. Each model's README must be independent and complete, and strictly associated with its corresponding GitHub repository as follows:
Llama-3.2-3B-quantized.w8a8: No dedicated GitHub repository.
Llama-3.2-3B-Instruct-FP8: No dedicated GitHub repository.
Llama-3.2-3B-Instruct-AWQ: Corresponding GitHub repository is https://github.com/jianan-gu/sglang/tree/cpu_optimized."""
